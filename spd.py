"""SPD manifold utilities copied from facebookresearch/riemannian-fm.

This module contains the Symmetric Positive Definite manifold definition from
https://github.com/facebookresearch/riemannian-fm

Copyright (c) Meta Platforms, Inc. and affiliates.

This specific file is licensed under the Creative Commons Attribution-NonCommercial 
4.0 International Public License (CC BY-NC 4.0). 

See LICENSE file for details or visit https://github.com/facebookresearch/riemannian-fm/blob/main/LICENSE
"""
